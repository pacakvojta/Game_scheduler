...
def index():
    if request.method == "POST":
        ...
        text_ouput, matrix_final ,matrix_teammates, matrix_opponents = create_game_schedule(**player_inputs, rounds=rounds)

        return render_template("result.html", text_output=text_ouput,  df1=matrix_final, df2=matrix_teammates, df3=matrix_opponents) # Run the function with user's inputs
    else:
